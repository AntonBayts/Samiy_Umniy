	...
	for (i = 0; i < 10; i++) {
		if (i == 0) {
			...
			strcpy(questions[i],
			       ...
			       "country?");
			answers[i] =
			    (char *)malloc(strlen("Vietnam") * sizeof(char));
		...
		if (i == 1) {
			...
			strcpy(questions[i],
			       ...
			       "Mexico?");
			answers[i] = (char *)malloc(strlen("The president") *
						    sizeof(char));
		...
		if (i == 2) {
			...
			strcpy(questions[i],
			       "What sport is Chris Evert-Lloyd famous for?");
			answers[i] =
			    (char *)malloc(strlen("Tennis") * sizeof(char));
		...
		if (i == 3) {
			...
			strcpy(questions[i],
			       ...
			       "call Il Duce?");
			answers[i] = (char *)malloc(strlen("Benito mussolini") *
						    sizeof(char));
		...
		if (i == 4) {
			...
			answers[i] =
			    (char *)malloc(strlen("Brass") * sizeof(char));
		...
		if (i == 5) {
			...
			strcpy(questions[i],
			       "What young girl helped to oust the British "
			       "from the French land in the 15th century?");
			answers[i] = (char *)malloc(strlen("Joan of Arc") *
						    sizeof(char));
		...
		if (i == 6) {
			...
			strcpy(questions[i],
			       ...
			       "straw into gold?");
			answers[i] = (char *)malloc(strlen("Rumpleshtiltshen") *
						    sizeof(char));
		...
		if (i == 8) {
			...
			answers[i] =
			    (char *)malloc(strlen("Indonesia") * sizeof(char));
		...
		if (i == 7) {
			questions[i] = (char *)malloc(
			    ...
			    sizeof(char));
			strcpy(questions[i],
			       "What does DOS mean in computer science?");
		...
		if (i == 9) {
			...
			answers[i] =
			    (char *)malloc(strlen("Antarctica") * sizeof(char));
